        ...
        <div id="main-slide" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img class="img-responsive" src="<?=Config::get('constantes.SRC_SITE')?>images/header-bg-1.jpg" alt="slider">
                ...
                <div class="item">
                    <img class="img-responsive" src="<?=Config::get('constantes.SRC_SITE')?>images/header-back.png" alt="slider">
                ...
                <div class="item">
                    <img class="img-responsive" src="<?=Config::get('constantes.SRC_SITE')?>images//galaxy.jpg" alt="slider">
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated2">
                        ...
                        <ul id="portfolio-list">
                            <li>
                                <div class="portfolio-item">
                                    <img src="<?=Config::get('constantes.SRC_SITE')?>images/portfolio/img1.jpg" class="img-responsive" alt="" />
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="<?=Config::get('constantes.SRC_SITE')?>images/portfolio/img2.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="<?=Config::get('constantes.SRC_SITE')?>images/portfolio/img3.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="<?=Config::get('constantes.SRC_SITE')?>images/portfolio/img4.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="<?=Config::get('constantes.SRC_SITE')?>images/portfolio/img5.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="<?=Config::get('constantes.SRC_SITE')?>images/portfolio/img6.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="welcome-section text-center">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/about-01.jpg" class="img-responsive" alt="..">
                ...
                <div class="col-md-4">
                    <div class="welcome-section text-center">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/about-02.jpg" class="img-responsive" alt="..">
                ...
                <div class="col-md-4">
                    <div class="welcome-section text-center">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/about-03.jpg" class="img-responsive" alt="..">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="carousel-example-generic" class="carousel slide about-slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="<?=Config::get('constantes.SRC_SITE')?>images/about-01.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="<?=Config::get('constantes.SRC_SITE')?>images/about-02.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="<?=Config::get('constantes.SRC_SITE')?>images/about-03.jpg" alt="">
                            </div>
                    ...
                    <div id="team-section">
                                ...
                                <div class="our-team">
                                    ...
                                    <div class="team-member">
                                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/team/manage-1.png" class="img-responsive" alt="">
                                    ...
                                    <div class="team-member">
                                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/team/manage-2.png" class="img-responsive" alt="">
                                        <div class="team-details">
                                            <h4>John Doe</h4>
                                            <p>Founder & Director</p>
                                            <ul>
                                    ...
                                    <div class="team-member">
                                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/team/manage-3.png" class="img-responsive" alt="">
                                        <div class="team-details">
                                            <h4>John Doe</h4>
                                            <p>Founder & Director</p>
                                            <ul>
                                    ...
                                    <div class="team-member">
                                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/team/manage-4.png" class="img-responsive" alt="">
                                        <div class="team-details">
                                            <h4>John Doe</h4>
                                            <p>Founder & Director</p>
                                            <ul>
            ...
            <div id="testimonial-carousel" class="testimonials-carousel">
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/testimonial/face_1.png" alt="" >
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/testimonial/face_2.png" alt="" >
                        <div class="testimonial-author">
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/testimonial/face_3.png" alt="" >
                        <div class="testimonial-author">
                            <div class="author">John Doe</div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="clients">
                    ...
                    <div class="col-md-12">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/logos/themeforest.jpg" class="img-responsive" alt="...">
                    </div>
                    
                    <div class="col-md-12">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/logos/creative-market.jpg" class="img-responsive" alt="...">
                    </div>
                    
                    <div class="col-md-12">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/logos/designmodo.jpg" class="img-responsive" alt="...">
                    </div>
                    ...
                    <div class="col-md-12">
                        <img src="<?=Config::get('constantes.SRC_SITE')?>images/logos/microlancer.jpg" class="img-responsive" alt="...">
                    </div>
